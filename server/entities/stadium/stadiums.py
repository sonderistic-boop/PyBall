...
class smallStadium(Stadium):
    ...
    def __init__(self,screen,position,teams):
        ...
        self.lines = {
            "top" : Line(self.screen,False,True,(self.bounds["x1"],self.bounds["y1"]-4),(self.bounds["x2"],self.bounds["y1"]+4)),
            "bottom" : Line(self.screen,False,True,(self.bounds["x1"],self.bounds["y2"]-4),(self.bounds["x2"],self.bounds["y2"]+4)),
